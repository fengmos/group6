  ...
  <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=6LgOMCDWb7FOHEtg9YKDQldEhP1kYS9N"></script>
	...
	<div class="block_home_slider">
        ...
        <ul class="decript-list">
        	...
        	<li>
        		<span class="color">单价：</span>57424万/元
        	</li>
        	<li>
        		<span class="sy"><span class="color">首付</span>：168万</span>
        		<span class="sy"><span class="color">月供：</span>2222元</span>
        	</li>
        	<li>
        	...
        	<li>
        		<span class="color">装修：</span>精装
        	</li>
        	<li>
        		<span class="color">地址：</span>北京市海淀区
        	</li>
        </ul>
