...
$(document).ready(function(){
    $(".more").click(function(){
        if ($('.more-eject').hasClass('grade-w-roll')) {
            $('.more-eject').removeClass('grade-w-roll');
        } else {
            $('.more-eject').addClass('grade-w-roll');
        }
    });
});
$(document).ready(function(){
    $(".more-Sort>li").click(function(){
        $(".more-t")
            .css("left","50%")
    });
});
...
function more(sbj){
    var arr = document.getElementById("more-Sort").getElementsByTagName("li");
    for (var i = 0; i < arr.length; i++){
        var a = arr[i];
        a.style.background = "";
    };
...
function more1(sbj){
    var arr = document.getElementById("more").getElementsByTagName("li");
    for (var i = 0; i < arr.length; i++){
        var a = arr[i];
        a.style.background = "";
    };
