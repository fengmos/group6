...
<head lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('static_wx/css/style.css')); ?>">
    ...
    <script src="<?php echo e(url('static_wx/js/house.js')); ?>"></script>
</head>
<body>
	<header class="main1">
		<a href="<?php echo e(url('wx')); ?>"><img src="<?php echo e(url('static_wx/img')); ?>/logo.png" class="logo"></a>
		<div class="top">
		...
		<a href="" class="me"><img src="<?php echo e(url('static_wx/img')); ?>/me.png" width="20" height="30"></a>
	</header>
	<nav class="nav1">
...
<div class="list-search" >
	<input type="text" class="list-input" placeholder="请输入小区或商圈名称"  />
	<a href="javascript:;" class="search-btn"><img src="<?php echo e(url('static_wx/img')); ?>/list-search.png"/></a>
</div>
<!--二手房搜索-->
<div class="search-none" style="display:none;">
	<div class="search-top">
	  <a href="javascript:;" class="table-cell" id="return"><img src="<?php echo e(url('static_wx/img')); ?>/return1.png"></a>
	  <div class="table-cell" style="width: 100%;">
	     <input class="none-input" type="text" placeholder="请输入小区或商圈名称" />
	  </div>
	  <a href="" class="table-cell"><img src="<?php echo e(url('static_wx/img')); ?>/search1.png" style="margin-left: 4px;"></a>
	</div>
</div><!--二手房搜索-->
...
<div class="Category-eject">
    <ul class="Category-w" id="Categorytw">
        ...
        <li onClick="Categorytw(this)"><a href="">30万以下</a></li>
...
<ul class="house-list">
    ...
    <?php foreach($list as $k=>$v): ?>
        	...
        	<li>
        		<a href="<?php echo e(url('housedetail')); ?>/<?php echo e($v->r_id); ?>.html">
        		<img class="house-pic" src="<?php echo e(url('static_wx/img')); ?>/2.jpg" />
        		<p class="house-title"><?php echo e($v->r_title); ?></p>
        		<p class="house-type"><?php echo e($v->r_type); ?></p>
        		<p class="house-address"><?php echo e($v->r_adress); ?></p>
        		<p class="house-tag">
        		...
        		<span class="h-price" title="93"><?php echo e($v->r_price); ?></span>
        		</a>
        	</li>
        <?php endforeach; ?>
